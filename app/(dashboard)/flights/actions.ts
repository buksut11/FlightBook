  ...
  if (id) {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        price_economy_child: d.price_economy_child,
        price_economy_infant: d.price_economy_infant,
        price_business_child: d.price_business_child,
        price_business_infant: d.price_business_infant,
